...
export interface ApiAiBlogAiBlog extends Struct.CollectionTypeSchema {
  collectionName: 'ai_blogs';
  info: {
    description: '';
    displayName: 'AiBlog';
    pluralName: 'ai-blogs';
    singularName: 'ai-blog';
  };
  options: {
...
export interface ApiAuthorAuthor extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    type: Schema.Attribute.Enumeration<
      ['hub', 'ultimate', 'definitive', 'sponsored']
    >;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiChapterChapter extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.Text;
    design_url: Schema.Attribute.String;
    encharge_tag: Schema.Attribute.String;
    ...
    publishedAt: Schema.Attribute.DateTime;
    resources: Schema.Attribute.Relation<'oneToMany', 'api::post.post'>;
...
export interface ApiHubHub extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    activate_waiting: Schema.Attribute.Boolean;
    author: Schema.Attribute.Relation<'oneToOne', 'api::author.author'>;
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::hub.hub'> &
      Schema.Attribute.Private;
    paddle_plan_id: Schema.Attribute.String;
    paddlePlanId: Schema.Attribute.String;
    ...
    type: Schema.Attribute.Enumeration<
      ['hub', 'definitive', 'pdf', 'book', 'course']
    > &
...
export interface ApiPostPost extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    is_sticky: Schema.Attribute.Boolean;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    ...
    title: Schema.Attribute.String & Schema.Attribute.Required;
    type: Schema.Attribute.Enumeration<
      ['hub', 'definitive', 'sponsored', 'ultimate', 'book', 'pdf']
    >;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiProjectProject extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    frontend: Schema.Attribute.String;
    image: Schema.Attribute.String;
...
declare module '@strapi/strapi' {
  export namespace Public {
    export interface ContentTypeSchemas {
      ...
      'api::ai-blog.ai-blog': ApiAiBlogAiBlog;
